defmodule ConnectFour.Web do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ConnectFour.Web
      import Plug.Conn
      import ConnectFour.Web.Router.Helpers
      import ConnectFour.Web.Gettext
    end
  end
  ...
  def view do
    quote do
      ...
      import ConnectFour.Web.Router.Helpers
      import ConnectFour.Web.ErrorHelpers
      import ConnectFour.Web.Gettext
    end
  end
